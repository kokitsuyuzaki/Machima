...
expect_equal(dim(out1$W_Epi), c(15, 3))
...
expect_equal(dim(out2$W_Epi), c(15, 3))
...
expect_true(is.list(out3$W_Epi))
expect_equal(dim(out3$W_Epi[[1]]), c(25, 3))
expect_equal(dim(out3$W_Epi[[2]]), c(35, 3))
expect_equal(dim(out3$W_Epi[[3]]), c(20, 3))
expect_equal(dim(out3$W_Epi[[4]]), c(30, 3))
expect_equal(dim(out3$W_Epi[[5]]), c(40, 3))
...
expect_true(is.list(out4$W_Epi))
expect_equal(dim(out4$W_Epi[[1]]), c(25, 3))
expect_equal(dim(out4$W_Epi[[2]]), c(35, 3))
expect_equal(dim(out4$W_Epi[[3]]), c(20, 3))
expect_equal(dim(out4$W_Epi[[4]]), c(30, 3))
expect_equal(dim(out4$W_Epi[[5]]), c(40, 3))
