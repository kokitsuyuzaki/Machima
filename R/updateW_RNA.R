...
.updateW_RNA_HZL <- function(X_RNA, X_GAM, W_RNA, H_RNA, H_Epi, J, Beta,
    L1_W_RNA, L2_W_RNA, orderReg, lambda_orthW, root, Pi_RNA, Pi_Epi){
    if(is.matrix(X_RNA)){
        W_RNA <- .updateW_RNA_HZL_Matrix(X_RNA, X_GAM, W_RNA, H_RNA, H_Epi, J, Beta, L1_W_RNA, L2_W_RNA, orderReg, lambda_orthW, root, Pi_RNA, Pi_Epi)
    }else{
        W_RNA <- .updateW_RNA_HZL_List(X_RNA, X_GAM, W_RNA, H_RNA, H_Epi, J, Beta, L1_W_RNA, L2_W_RNA, orderReg, lambda_orthW, root, Pi_RNA, Pi_Epi)
    }
    W_RNA
}
